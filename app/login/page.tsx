...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#0B3D2E] font-sans">
      ...
      >
        ...
        />
        {step === 'auth' && (
          <p className="mt-4 text-sm text-[#070707]">Selamat datang kembali</p>
        )}
      </div>
        ...
        {step === 'welcome' && (
          <div className="flex h-full flex-col">
            <div className="flex-1">
              <h1 className="text-3xl font-bold tracking-tight text-[#0B3D2E]">
                Selamat Datang
              </h1>
          ...
          <div className="flex h-full flex-col">
            ...
            {tab === 'login' ? (
              <form onSubmit={handleSubmit} className="flex flex-1 flex-col">
                <h2 className="mb-5 text-xl font-bold text-[#0B3D2E]">Sign in</h2>
